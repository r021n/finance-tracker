...
export default function TransactionFilter({
  ...
  return (
    <div className="relative">
      ...
      {isOpen && (
        <div className="absolute right-0 top-12 z-30 w-80 rounded-xl border border-zinc-200 bg-white p-4 shadow-xl">
          <div className="mb-4 flex items-center justify-between">
            <h3 className="font-semibold text-zinc-900">Filter Transaction</h3>
            <button
              type="button"
